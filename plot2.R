# This script reconstructs Plot 2 from Course Project 1 of Exploratory Data Analysis
# into the plot2.png file usinf base plotting system of R.
...
# Build Plot 2
with(data, plot(datetime, global.active.power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = ""))
